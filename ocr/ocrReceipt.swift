...
struct ReceiptData {
    ...
    var date: String?
    var cost: Double
    init (company: String? = nil, date: String? = nil, cost: Double = 0.0) {
        self.company = company == "" ? nil : company
        self.date = date == "" ? nil : date
        self.cost = cost
    }
}
...
func callOCRSpace(apiKey: String, photoString: String, urlNot64: Bool) -> ReceiptData {
    ...
    */
    ...
    return(ReceiptData.init(company: company, date: date, cost: estimatedTotal))
}